...
class BaseCommand(object):
    ...
    def show_usage(self, start, stop):
        ...
        r = [
            ...
            f"             Max RSS     : {stop.ru_maxrss - start.ru_maxrss}M",
            f"        Shared mem. size : {stop.ru_ixrss - start.ru_ixrss}M",
            f"      Unshared mem. size : {stop.ru_idrss - start.ru_idrss}M",
            f"     Unshared stack size : {stop.ru_isrss - start.ru_isrss}M",
