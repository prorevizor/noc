...
class Config(BaseConfig):
    ...
    class chwriter(ConfigSection):
        ...
        channel_expire_interval = SecondsParameter(default="5M", help="Close channel when no messages in this time")
        suspend_timeout_ms = IntParameter(default=3000, help="How much time to sleep before continue")
        # Topic to listen
        ...
        max_in_flight = IntParameter(default=10, help="How many parts read simultaneously from queue")
